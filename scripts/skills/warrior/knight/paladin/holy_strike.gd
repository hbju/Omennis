...
func get_skill_description() -> String:
	return "Deal " + str(damage_mult) + " times your basic damage to an enemy and heal yourself for " + str(heal_percentage * 100) + "% of the damage dealt.\n" + \
