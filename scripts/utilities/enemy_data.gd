...
static var ENEMY_CLASS_DEFINITIONS = {
	...
	"Arcane Channeler": {
		...
		"skill_pool_config": [
			{"skill": FiresparkMage, "min_level": 1},
    ...
    "Raging Berserker": {
        ...
        "base_damage_stat": 5, "damage_stat_per_level": 1,
        "skill_pool_config": [
            {"skill": Frenzy, "min_level": 1},
            {"skill": RagingBlow, "min_level": 3},
    ...
    "Lich Warrior": {
        ...
        "base_damage_stat": 7, "damage_stat_per_level": 1.5,
        "skill_pool_config": [
            {"skill": ArcaneSlash, "min_level": 1},
            {"skill": BoneArmor, "min_level": 3},
