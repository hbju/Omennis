...
static var ENEMY_CLASS_DEFINITIONS = {
	...
	"Arcane Channeler": {
		...
		"base_damage_stat": 5, "damage_stat_per_level": 5,
		"skill_pool_config": [
    ...
    "Frost Guardian": {
        ...
        "base_damage_stat": 7, "damage_stat_per_level": 3,
        "skill_pool_config": [
    ...
    "Ash-Chitterer Queen" : {
        "class_enum": Character.CLASSES.Warrior,
        "base_hp": 240, "hp_per_level": 40,
        "base_damage_stat": 20, "damage_stat_per_level": 0,
        "skill_pool_config": [
