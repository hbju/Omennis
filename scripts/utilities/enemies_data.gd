...
static var ENEMY_CLASS_DEFINITIONS = {
	"Brute Marauder": {
		...
		"portraits": [0],
        "loot_tables": [
            preload("res://items/loot_tables/brute_marauder_table.tres") as LootTable,
        ]
	},
	"Arcane Channeler": {
    ...
    "Lich Warrior": {
        ...
        "base_damage_stat": 7, "damage_stat_per_level": 5,
        "skill_pool_config": [
            {"skill": ArcaneSlash, "min_level": 2},
            {"skill": BoneArmor, "min_level": 4},
            {"skill": DeathCoil, "min_level": 6}
    ...
    "Ash-Chitterer" : {
        ...
        "skill_pool_config": [
            {"skill": Charge, "min_level": 2},
            {"skill": PoisonDagger, "min_level": 4},
            {"skill": DeathCoil, "min_level": 6}
        ],
        "portraits": [28, 29, 30]
    },
